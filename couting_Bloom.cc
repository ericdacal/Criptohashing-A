...
couting_Bloom::couting_Bloom(int size, int numHash, int maxKeys) {
...
vector <int> erastosthenesSievec(int maxNumKeys) {
...
void couting_Bloom::createTwoHashFunctions() {
    vector <int> aux = erastosthenesSievec(maxNumKeys);
